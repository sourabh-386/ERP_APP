...
const Employee_parent = () => {
    const{emp_table,Emp_save_btn,emp_hr_table_data,set_disable_form,disable_form} =useContext(Emp_Table_context)
    return (
        <div className='outer_item_div'>
            ...
            <div className='Item_table_btns'>
                <button onClick={() => { Submit_emp_details_fn(Emp_save_btn, emp_table,emp_hr_table_data,set_disable_form,disable_form) }}><b>Submit</b></button>
